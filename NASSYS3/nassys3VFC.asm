	...
	; moded by David Allday - 26 august 2020
	; to output to port 0xef to set the MAP80 VFC display switch to the nascom display.
	; 	assuming that the VFC link L2 set a--d and b--c 
	; 	This allows the default setting on the VFC card to be for CPM
